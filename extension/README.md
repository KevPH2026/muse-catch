...
| 🐦 **Twitter/X** | 点赞/收藏推文 → **自动捕获**（右下角弹提示） |
| 📱 **微信公众号** | 阅读文章超过 3 秒 → **自动捕获** |
...
| 平台 | 触发条件 | 捕获内容 |
|------|----------|----------|
| 🐦 Twitter/X | 点赞 / 收藏 / 书签 / 按L键 | 推文全文 + 作者 + 链接 |
| 📱 微信公众号 | 阅读 > 3 秒 | 文章标题 + 全文 + 作者 |
| 📚 微信读书 | 划线 / 复制文字 / 写笔记 | 划线内容 + 书名 + 章节 + 作者 |

右下角会弹 toast 提示捕获结果。需 Muse API 在 `localhost:5200` 运行。
